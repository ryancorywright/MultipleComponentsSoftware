...
# Note: you also need to run the other table 3-4 script file to fully reproduce tables 3-4 (or our approaches results on tables 3-4 anyway, you will need to download R and Matlab to reproduce Zou et al and Hein and Buhler's results)
...
for r=2:3
    for theK=5:5:10
        ...
        run_exact=@elapsed ofv_exact, bound_exact, nodes_exact, gap_exact, U_exact, z_exact=solveExact_direct(pitprops, theK*r, r, repeat([theK], r), runtime_grb, 1e-4, true, z_rounded)
        ...
        run_exact_reduced=@elapsed ofv_exact_reduced, bound_exact_reduced, nodes_exact_reduced, gap_exact_reduced, U_exact_reduced, z_exact_reduced=solveExact_direct(pitprops_reduced, theK*r, r, repeat([theK], r), runtime_grb, 1e-4, true, z_rounded[indices_reduced,:])
...
for r=2:3
    for theK=5:5:10
        ...
        # Next, solve via Gurobi (full) with time limit of 1 hour
        run_exact=@elapsed ofv_exact, bound_exact, nodes_exact, gap_exact, U_exact, z_exact=solveExact_direct(normwine, theK*r, r, repeat([theK], r), runtime_grb, 1e-4, true, z_rounded)
        ...
        run_exact_reduced=@elapsed ofv_exact_reduced, bound_exact_reduced, nodes_exact_reduced, gap_exact_reduced, U_exact_reduced, z_exact_reduced=solveExact_direct(normwine_reduced, theK*r, r, repeat([theK], r), runtime_grb, 1e-4, true, z_rounded[indices_reduced,:])
...
for r=2:3
    for theK in [5, 10, 20]
        ...
        # Next, solve via Gurobi (full) with time limit of 1 hour
        run_exact=@elapsed ofv_exact, bound_exact, nodes_exact, gap_exact, U_exact, z_exact=solveExact_direct(normionosphere, theK*r, r, repeat([theK], r), runtime_grb, 1e-4, true, z_rounded)
        ...
        run_exact_reduced=@elapsed ofv_exact_reduced, bound_exact_reduced, nodes_exact_reduced, gap_exact_reduced, U_exact_reduced, z_exact_reduced=solveExact_direct(normionosphere_reduced, theK*r, r, repeat([theK], r), runtime_grb, 1e-4, true, z_rounded[indices_reduced,:])
...
for r=2:3
    for theK in [5, 10, 20]
        ...
        # Next, solve via Gurobi (full) with time limit of 1 hour
        run_exact=@elapsed ofv_exact, bound_exact, nodes_exact, gap_exact, U_exact, z_exact=solveExact_direct(normGeographic, theK*r, r, repeat([theK], r), runtime_grb, 1e-4, true, z_rounded)
        ...
        run_exact_reduced=@elapsed ofv_exact_reduced, bound_exact_reduced, nodes_exact_reduced, gap_exact_reduced, U_exact_reduced, z_exact_reduced=solveExact_direct(normGeographic_reduced, theK*r, r, repeat([theK], r), runtime_grb, 1e-4, true, z_rounded[indices_reduced,:])
...
for r=2:3
    for theK in [5, 10, 20]
        ...
        # Next, solve via Gurobi (full) with time limit of 1 hour
        run_exact=@elapsed ofv_exact, bound_exact, nodes_exact, gap_exact, U_exact, z_exact=solveExact_direct(normcommunities, theK*r, r, repeat([theK], r), runtime_grb, 1e-4, true, z_rounded)
        ...
        run_exact_reduced=@elapsed ofv_exact_reduced, bound_exact_reduced, nodes_exact_reduced, gap_exact_reduced, U_exact_reduced, z_exact_reduced=solveExact_direct(normcommunities_reduced, theK*r, r, repeat([theK], r), runtime_grb, 1e-4, true, z_rounded[indices_reduced,:])
...
for r=2:3
    for theK in [5, 10, 20]
        ...
        # Next, solve via Gurobi (full) with time limit of 1 hour
        run_exact=@elapsed ofv_exact, bound_exact, nodes_exact, gap_exact, U_exact, z_exact=solveExact_direct(normarrhythmia, theK*r, r, repeat([theK], r), runtime_grb, 1e-4, true, z_rounded)
        ...
        run_exact_reduced=@elapsed ofv_exact_reduced, bound_exact_reduced, nodes_exact_reduced, gap_exact_reduced, U_exact_reduced, z_exact_reduced=solveExact_direct(normarrhythmia_reduced, theK*r, r, repeat([theK], r), runtime_grb, 1e-4, true, z_rounded[indices_reduced,:])
...
for r=2:3
    for theK=5:5:10
        ...
        doDisjoint=true
        # Solve relaxation in order to compare variable fixing
        run_sdp_disj=@elapsed UB_sdp_disj, x_rounded, LB_gd_disj, violation_gd_disj, z_relax = getSDPUpperBound_gd_multiple_permutation(micromass, r, repeat([theK], r),  usePSD, useSOC, useCuts, doDisjoint)
        @show UB_sdp_disj, run_sdp_disj
        z_rounded=1.0*(abs.(x_rounded).>1e-4)


        # Next, solve via Gurobi (full) with time limit of 1 hour
        run_exact=@elapsed ofv_exact, bound_exact, nodes_exact, gap_exact, U_exact, z_exact=solveExact_direct(micromass, theK*r, r, repeat([theK], r), runtime_grb, 1e-4, true, z_rounded)
        ...
        run_exact_reduced=@elapsed ofv_exact_reduced, bound_exact_reduced, nodes_exact_reduced, gap_exact_reduced, U_exact_reduced, z_exact_reduced=solveExact_direct(micromass_reduced, theK*r, r, repeat([theK], r), runtime_grb, 1e-4, true, z_rounded[indices_reduced,:])
